...
export class FiltersComponent {
  ...
  startRange:number=2000;
  endRange:number=4000;
  // end of price range variables 

  typesOfPlace = [
    {id:1,title:'Entire place', subtitle:'A place all to yourself', checked:false},
    {id:2,title:'Private room', subtitle:'Your own room in a home or a hotel, plus some shared common spaces', checked:false},
    {id:3,title:'Shared room', subtitle:'A sleeping space and common areas that may be shared with others', checked:false}
  ]
  ...
  propertyType = [
    {img:"https://a0.muscache.com/pictures/4d7580e1-4ab2-4d26-a3d6-97f9555ba8f9.jpg",propertyTitle:'House'},
    {img:"https://a0.muscache.com/pictures/21cfc7c9-5457-494d-9779-7b0c21d81a25.jpg",propertyTitle:'Flat'},
    {img:"https://a0.muscache.com/pictures/6f261426-2e47-4c91-8b1a-7a847da2b21b.jpg",propertyTitle:'Guest house'},
    {img:"https://a0.muscache.com/pictures/64b27fed-56a1-4f03-950a-d8da08efb428.jpg",propertyTitle:'Hotel'}
  ]
  ...
  addRemoveRoomsBeds(element:QueryList<ElementRef>, number:number){
    ...
    this.renderer.addClass(element.toArray()[number].nativeElement,'activeRoomsBeds')
  }
  ...
  slideConfig = { slidesToShow: 11, slidesToScroll: 11, infinite: false,swipe:true};
